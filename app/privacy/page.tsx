...
export default function Privacy() {
  return (
    <main id="main" className="interior-page legal-page">
      ...
      <p>This policy explains how Homey Hoppers LLC handles information in connection with our website, inquiries, and NYC apartment touring and documentation services.</p>
      <section><h2>Information we collect</h2><p>We receive information you provide through our inquiry form, email, or tour communications. This may include your name, email address, phone number, apartment listing and address, showing details, tour preferences, questions you want checked, and payment confirmation information. We also receive documentation you send to support a refund or restored tour credit.</p><p>Providing the service produces photos, videos, notes, and communications about the showing. Please do not send Social Security numbers, financial account details, identification documents, or other sensitive information through our inquiry form or email.</p></section>
      <section><h2>How we use information</h2><p>We use this information to respond to inquiries, coordinate and confirm tours, confirm receipt of payments, communicate with you and the showing contact, deliver documentation, manage package credits, review cancellation requests, and maintain service records.</p></section>
      <section><h2>Who receives information</h2><p>Information needed to arrange or carry out your tour may be shared with your assigned Hopper and the broker, agent, or other showing contact. Providers that support our forms, email, website hosting, booking administration, payment confirmations, and tour communications also process information as part of delivering those services. Information may also be disclosed when required by law or necessary to address fraud, safety concerns, or legal claims.</p></section>
      <section><h2>Google Forms and website hosting</h2><p>Our inquiry form is hosted by Google and embedded on the booking page. Loading or using it connects your browser to Google, which may process technical information and use cookies under its own <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">Privacy Policy</a>. Your form responses are provided to Homey Hoppers LLC.</p><p>Our website is hosted on Vercel. Hosting providers may process technical information such as IP addresses, browser details, requested pages, and access times to deliver and secure the site. See <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer">Vercel’s Privacy Policy</a>. Browser settings can limit cookies, although this may affect embedded services.</p></section>
      <section>
        <h2>Instinct and administrative assistance</h2>
        <p>We use Instinct, an AI assistant, to help handle inquiry entries, confirm bookings, confirm when payments have been made, and respond to inquiry emails. To carry out these tasks, Instinct may access and process information made available through our connected accounts and tools, including your contact details, inquiry submissions, email correspondence, booking details, and payment confirmation information.</p>
        <p>Inquiry replies and booking or payment confirmations may be prepared or sent with Instinct’s assistance. For information about how Instinct handles data, see <a href="https://instinct.com/privacy-policy" target="_blank" rel="noopener noreferrer">Instinct’s Privacy Policy</a>.</p>
      </section>
